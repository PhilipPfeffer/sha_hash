...
- Software Simulation
- Hardware Implementation and Design Tradeoffs
- Appendix
...
```
Below you can find the general block diagram of the SHA 256 algorithm.
![SHA 256 Block Diagram](./img/sha256_hw_diagram.png)
...
Finally, here is the diagram for this last design iteration:
![Design iteration 4](./img/method4.png)

### Performance Comparison
Below you can find performance data for methods 3 and 4, which were described above.
